...
# Loaded by path, matching the idiom the rest of this suite uses for nightly.py:
# there is no package install step here and no root conftest to lean on.
HERE = Path(__file__).resolve().parent
_spec = importlib.util.spec_from_file_location(
    "structural_yield", HERE.parent / "research" / "structural_yield.py")
